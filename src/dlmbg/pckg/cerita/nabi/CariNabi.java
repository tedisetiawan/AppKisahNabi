...
public class CariNabi extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.data_nabi);
		...
		Cursor cursor = sqliteDB.bacaDataPencarianNabi(cari);
		startManagingCursor(cursor);
		
		cari_et = (EditText) findViewById(R.id.cari_data);

		String[] awal = new String[] { "nama_nabi" };
		...
		Button button = (Button) findViewById(R.id.btn_cari_data);
	...
	public void hapus(long rowId) {
    	sqliteDB.hapusData(rowId, "tbl_nabi", "_id");
	...
	public void tampilTempatTerseleksi(Long mRowId) {
		Cursor cursor = sqliteDB.bacaDataTerseleksiNabi(mRowId);
		Intent intent = new Intent(this, DetailNabi.class);
		intent.putExtra("id_penemu", cursor.getString(0));
		intent.putExtra("nama_nabi", cursor.getString(1));
	...
	public void CariData() {
		Intent intent = new Intent(this, CariNabi.class);
